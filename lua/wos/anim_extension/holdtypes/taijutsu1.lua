...
DATA.Translations[ ACT_MP_ATTACK_STAND_PRIMARYFIRE ]	= "foc_warwax_jeet_bl" 
DATA.Translations[ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE ]	= "foc_warwax_jeet_bl" 
DATA.Translations[ ACT_MP_RELOAD_STAND ]				= "foc_warwax_jeet_fl"
