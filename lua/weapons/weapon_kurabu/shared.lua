...
SWEP.WorldModel = "models/naruto/yuno/ukie_baton.mdl"
...
function SWEP:Deploy()
	...
	self.Owner:SetModel("models/falko_naruto_foc/body_upper/man_ym_yagura.mdl")
...
function growCorals(ply, self, max,damage)
    ...
    for i = 1, max do
        timer.Simple(i * 0.1, function()
            ...
            if IsValid(modelEntity) then
                modelEntity:SetModel("models/fsc/billy/corail.mdl")

                local startPos = traceResult.HitPos - Vector(0, 0, 30)
                local endPos = traceResult.HitPos + Vector(0, 0, 30)
                ...
                local particleName = "[3]_water_swirl_add_5"
...
function SWEP:Reload()
    ...
    self.NextSpecialMove = CurTime() + 8
