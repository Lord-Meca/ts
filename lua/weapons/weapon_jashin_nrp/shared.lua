...
if (CLIENT) then
	...
	SWEP.SlotPos = 0
	SWEP.DrawAmmo = false
	SWEP.PrintName = "Faux à Trois Lames"
...
SWEP.WorldModel = "models/naruto/unique/unique6/foc_nr_unique6_bane.mdl"
...
--==================--
function SWEP:DoCombo( hitsound, combonumber, force, freezetime, attackdelay, anim, viewbob, primarystuntime, stuntime, sound, sounddelay, hastrail, haspush, push, pushdelay, aircombo ,pushenemy,bleed)
	local ply = self.Owner
	self.back = false
...
function SWEP:Reload()
	...
	timer.Simple(0.3, function()
		...
		self:DoCombo( AttackHit1, 11, 150, 0, 0.16, "weapon_art", Angle(3, -3, 0),0, 0, Combo1, 0.14, false, false, 0, 0,false,true, true)
    end)
